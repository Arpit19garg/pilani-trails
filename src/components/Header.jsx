...
const Header = () => {
  ...
  return (
    <header className="app-header">
        ...
        {/* centered container so background is full-width but nav content stays centered */}
        <div className="header-inner">
          {/* Brand (with fallback if image missing) */}
          ...
          <ul className={`nav-links ${menuOpen ? "open" : ""}`}>
            ...
            {!currentUser ? (
              ...
              <>
                ...
                <li>
                  <Link to="/propose" onClick={() => setMenuOpen(false)}>
                    Propose Location
                  </Link>
                </li>
                ...
                {isAdmin && (
                  <>
                    <li>
                      <Link to="/admin/review" onClick={() => setMenuOpen(false)}>
                        Admin Review
                      </Link>
                    </li>
                    <li>
